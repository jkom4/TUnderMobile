...
class ConnexionRepository implements IConnexionRepository {
  ...
  Future signInWithGoogle() async {
    ...
    FirebaseAuth.instance.signInWithCredential(credential).then((value) =>   fecthSigninGoogle(value.user));
  ...
  Future fecthSigninGoogle(User? currentUser) async {
    var data = jsonEncode({ "Username" : currentUser?.displayName,"Password": currentUser?.email});
    var headers = {"Content-Type": "application/json"};
