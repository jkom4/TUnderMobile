...
import 'package:tunder/components/textfield_google.dart';
...
class _NavigationPageState extends State<NavigationPage> {
  ...
  void initState() {
    super.initState();
    _getCurrentLocation();
    destinationAddressController.text = widget.lieu;
    _destinationAddress = widget.lieu;
  }
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          textField(
                              label: 'Départ',
                              hint: 'Entrez le point de depart',
